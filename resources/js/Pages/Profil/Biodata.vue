...
@import '/resources/css/biodata.css';
...
<template>
    <div class="outer-container">
        <div class="container">
            ...
            <img src="/profile.png" alt="profile" width="90px" style="margin-top: -10px;display: block;
              margin-left: auto;
              margin-right: auto;
              ">
            <form action="/profil/biodata/update" method="post">
                ...
                <div class="form-row">
                    <input type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Depan" :value="biodata.nama_lengkap" required>
                </div>

                <label for="E-mail">Kontak:</label>
                <div class="form-row">
                    <input type="email" id="E-mail" name="email" class="half-input" placeholder="E-mail" :value="email" readonly>
                    <input type="tel" id="no-_hp" name="no_hp" class="half-input" placeholder="Nomor Handphone" :value="biodata.no_hp" required>
                </div>
                <div>
                    <label for="tanggal-lahir">Tanggal Lahir:</label>
                    <div class="form-row">
                        <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="half-input" :value="biodata.tanggal_lahir" required>
                    </div>
                </div>
...
<!--                               placeholder="Jenis Kelamin" :value="biodata.jenis_kelamin" required>-->
                ...
                <div class="form-row">
                    <input type="text" id="nama-depan" name="alamat" class="alamat" placeholder="Provinsi" :value="biodata.alamat" required>
                </div>
